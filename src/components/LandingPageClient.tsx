...
export default function LandingPageClient({ projectsCount, eventsCount, membersCount }: StatsProps) {
  const stats = [
    { label: 'Projects Shipped', value: `${projectsCount}+`, icon: Code2, color: '#8b5cf6' },
    { label: 'Hackathons', value: `${eventsCount}+`, icon: Trophy, color: '#f59e0b' },
    { label: 'Team Members', value: membersCount.toString(), icon: Users, color: '#06b6d4' },
    { label: 'Awards Won', value: '5', icon: Star, color: '#10b981' }, // Awards remain hardcoded for now
  ];
